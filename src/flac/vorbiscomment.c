...
typedef struct {
	...
	FLAC__uint32 field_value_length;
	char *field_value;
...
static FLAC__bool parse_vorbis_comment_field(const char *field_ref, char **field, char **name, char **value, FLAC__uint32 *length, const char **violation)
{
