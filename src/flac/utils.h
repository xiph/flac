...
typedef enum {
	SUBFORMAT_UNSPECIFIED = 0,
	SUBFORMAT_WAVE_PCM,
	SUBFORMAT_WAVE_EXTENSIBLE,
	SUBFORMAT_AIFF_C_NONE,
	SUBFORMAT_AIFF_C_RAW,
	SUBFORMAT_AIFF_C_SOWT,
	SUBFORMAT_AIFF_C_TWOS,
	SUBFORMAT_AIFF_C_IN24,
	SUBFORMAT_AIFF_C_IN32,
	SUBFORMAT_AIFF_C_42NI,
	SUBFORMAT_AIFF_C_23NI
} FileSubFormat;
