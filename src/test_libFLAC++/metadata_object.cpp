...
bool test_metadata_object_vorbiscomment()
{
	...
	printf("testing Entry::Entry(const char *field, FLAC__uint32 field_length)... ");
	...
	printf("testing Entry::Entry(const char *field_name, const char *field_value, FLAC__uint32 field_value_length)... ");
	...
	printf("testing Entry::set_field_value(const char *field_value, FLAC__uint32 field_value_length)... ");
	...
	printf("testing Entry::set_field(const char *field, FLAC__uint32 field_length)... ");
