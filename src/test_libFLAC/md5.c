...
static FLAC__bool test_md5_accumulate(const FLAC__int32 * const * signal,FLAC__uint32 channels, FLAC__uint32 samples, FLAC__uint32 bytes_per_sample, const FLAC__byte target_digest [16]);
...
static FLAC__bool test_md5_codec(void)
{
	...
	FLAC__uint32 chan, byte_size, seed = 0x12345679;
