...
static FLAC__int32 linear_dither(FLAC__uint32 source_bps, FLAC__uint32 target_bps, FLAC__int32 sample, dither_state *dither, const FLAC__int32 MIN, const FLAC__int32 MAX)
{
	FLAC__uint32 scalebits;
...
size_t FLAC__plugin_common__pack_pcm_signed_big_endian(FLAC__byte *data, const FLAC__int32 * const input[], FLAC__uint32 wide_samples, FLAC__uint32 channels, FLAC__uint32 source_bps, FLAC__uint32 target_bps)
{
	static dither_state dither[FLAC_PLUGIN__MAX_SUPPORTED_CHANNELS];
	FLAC__byte * const start = data;
	FLAC__int32 sample;
	const FLAC__int32 *input_;
	FLAC__uint32 samples, channel;
...
size_t FLAC__plugin_common__pack_pcm_signed_little_endian(FLAC__byte *data, const FLAC__int32 * const input[], FLAC__uint32 wide_samples, FLAC__uint32 channels, FLAC__uint32 source_bps, FLAC__uint32 target_bps)
{
	static dither_state dither[FLAC_PLUGIN__MAX_SUPPORTED_CHANNELS];
	FLAC__byte * const start = data;
	FLAC__int32 sample;
