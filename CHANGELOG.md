...
* General:
    ...
    * Compression of preset -3 through -8 was slightly improved at the cost of a small decrease in decoding speed by increasing the precision with which autocorrelation was calculated (Martijn van Beurden)
    * Speedups specifically targeting 64-bit ARMv8 devices were integrated (Ronen Gvili, Martijn van Beurden)
* (Ogg) FLAC format:
