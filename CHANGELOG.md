...
* metaflac:
    * (none)
* build system:
    * Various CMake improvements, especially for creating MSVC build files (Martijn van Beurden, CookiePLMonster, David Callu, Tyler Dunn)
...
* Interface changes:
    * libFLAC:
        ...
        * FLAC__stream_encoder_init_file, FLAC__stream_encoder_init_ogg_file, FLAC__stream_decoder_init_file and FLAC__stream_decoder_init_ogg_file now take UTF-8 filenames on Windows, and no longer accept filenames using the current codepage
    * libFLAC++:
        * Addition of ::set_limit_min_bitrate() and ::get_limit_min_bitrate(), see [github #264](https://github.com/xiph/flac/pull/264)
        * The ::init and ::init_ogg using filenames now take UTF-8 filenames on Windows, and no longer accept filesnames using the current codepage
